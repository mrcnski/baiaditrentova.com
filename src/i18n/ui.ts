...
export const ui = {
    en: {
        ...
        "reviews.description": "Read what our guests have to say about their stay with us!",
    ...
    it: {
        ...
        "reviews.description": "Leggi cosa dicono i nostri ospiti del loro soggiorno con noi!",
